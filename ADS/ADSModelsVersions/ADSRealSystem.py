...
class ADSRealSystem(ADSModelAbstract):
    ...
    def replace_actual_model_json(self, model_json):
        ...
        for layer in model_json["config"]["layers"]:
            if layer["name"] == "full_images":
                ...
                os.environ.setdefault("DIGITAL_MODEL_SIZE_IMAGES_WIDTH", widthImage)
                os.environ.setdefault("DIGITAL_MODEL_SIZE_IMAGES_HEIGHT", heightImage)
